...
namespace VanillaMemesExpanded
{
    public class ThoughtWorker_Precept_Royalty : ThoughtWorker_Precept_Social
    {
        protected override ThoughtState ShouldHaveThought(Pawn p, Pawn otherPawn)
        {
            ...
            if (Faction.OfEmpire is null || otherPawn.royalty is null || otherPawn.royalty.GetCurrentTitleInFaction(Faction.OfEmpire) is null || otherPawn.royalty.AllTitlesForReading.Count == 0)
            {
                return false;
            }

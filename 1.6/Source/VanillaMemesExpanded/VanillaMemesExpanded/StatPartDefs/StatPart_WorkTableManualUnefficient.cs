...
namespace VanillaMemesExpanded
{
	public class StatPart_WorkTableManualUnefficient : StatPart
	{
		...
		public static bool Applies(Thing th)
		{
			...
			return compPowerTrader == null && Current.Game.World.factionManager.OfPlayer.ideos.PrimaryIdeo.GetPrecept(InternalDefOf.VME_CraftingSpeed_SlowerForManual)!=null;
		}
	}
}

...
namespace VanillaMemesExpanded
{
	public class StatPart_WorkTableAutomationDecreased : StatPart
	{
		...
		public static bool Applies(Thing th)
		{
			...
			return StaticCollections.automaticWorkbenches.Contains(th.def) && Current.Game.World.factionManager.OfPlayer.ideos.PrimaryIdeo.GetPrecept(InternalDefOf.VME_AutomationEfficiency_Decreased)!=null;
		}
	}
}

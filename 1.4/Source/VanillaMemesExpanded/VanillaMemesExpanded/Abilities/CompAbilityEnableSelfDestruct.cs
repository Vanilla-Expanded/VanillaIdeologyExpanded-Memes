	...
	public class CompAbilityEnableSelfDestruct : CompAbilityEffect
	{
		...
		public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
		{
			...
			if (turret != null) {
                ...
                {
					GenExplosion.DoExplosion(target.Cell, target.Thing.Map, 3.9f, DamageDefOf.Bomb, this.parent.pawn, -1, -1f, null, null, null, null, null, 0f, 1, null,false, null, 0f, 1, 0f, false, null, null);
					turret.Destroy();
				}
			...
			} else if( mechanoid != null)
			{
                ...
                if (mechanoid.RaceProps.IsMechanoid) {
					GenExplosion.DoExplosion(target.Cell, target.Thing.Map, 5.9f, DamageDefOf.Bomb, this.parent.pawn, -1, -1f, null, null, null, null, null, 0f, 1, null,false, null, 0f, 1, 0f, false, null, null);
					mechanoid.Kill(null);
